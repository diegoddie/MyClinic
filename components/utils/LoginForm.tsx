    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border shadow-xl border-secondary">
        <CardHeader className="text-center">
          <CardTitle className="bg-gradient-to-r from-secondary to-primary text-transparent bg-clip-text text-xl font-bold tracking-tighter md:text-2xl lg:text-3xl">Welcome back</CardTitle>
          ...
          <form>
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center text-sm text-primary">
                ...
                <Link href="/sign-up" className="underline underline-offset-4 font-semibold">
                  Sign up
                </Link>
              </div>
            </div>
