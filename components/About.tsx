...
import { Building2, CheckCircle2, CircleChevronRight, MessageCircleQuestion } from 'lucide-react'
...
export default function About() {
  ...
  return (
    <section className="py-12 lg:py-24 bg-gradient-to-b from-background to-foreground/25" id="about">
      <div className="container mx-auto px-4 md:px-6 py-1 md:py-4">
        <div className="flex flex-col items-center space-y-5 text-center mb-12">
          ...
          <p className="mx-auto max-w-2xl text-paragraphs text-lg md:text-xl">
            Delivering exceptional healthcare services with a focus on patient comfort and modern medical solutions.
          </p>
          <Badge variant="outline" className="text-primary border border-green-400 bg-green-50 px-4 py-1 tracking-tight text-md font-semibold">
            Version 2.0 is here! 🎉
          </Badge>
        </div>
                    ...
                    <div className="space-y-3">
                      {highlights.map((highlight, index) => (
                        <div key={index} className="flex items-center space-x-3">
                          ...
                          <span className='text-paragraphs text-start'>{highlight}</span>
                        </div>
                      ))}
                    </div>
                  </CardContent>
                ...
                <Card className=''>
                  <CardContent className="pt-6">
                    <p className="text-paragraphs">
                      Founded in 2000, MyClinic has been at the forefront of medical innovation for over two decades. 
                      What started as a small family practice has grown into a comprehensive healthcare center, 
                      serving thousands of patients with cutting-edge treatments and compassionate care.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
