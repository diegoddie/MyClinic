...
import { approveAppointment } from "@/utils/supabase/actions/adminActions";
...
function ApproveAppointmentDialog({
  ...
  const mutation = useMutation({
    mutationFn: async (appointment: AppointmentWithRelations) => {
      const result = await approveAppointment(appointment);
  ...
  const onApprove = async ({
    ...
    mutation.mutate(appointment); // Use the mutate function to approve the appointment
  };
